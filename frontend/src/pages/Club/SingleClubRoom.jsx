...
import styles from "./SingleClubRoom.module.css";
import Loader from "../../components/shared/Loader/Loader";

const SingleClubRoom = () => {
  const { roomId, clubId } = useParams();
  ...
  return (
    <div className="containerBox shadow-lg">
      ...
      >
        ...
        <span className=" ml-4">Go Back To Club</span>
      </button>
            ...
            return (
              <div className={styles.client} key={client.id}>
                <div className={styles.userHead}>
                  ...
                  >
                    {client.muted ? (
                      <img src="/image/mic-mute.png" alt="mic-mute-icon" />
                    ) : (
                      <img src="/image/mic.png" alt="mic-icon" />
                    )}
                  </button>
                </div>
